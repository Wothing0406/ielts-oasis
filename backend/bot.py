    ...
    if isinstance(message.channel, discord.DMChannel) or bot.user in message.mentions or is_reply_to_bot:
        ...
        async with message.channel.typing():
            ...
            if is_reply_to_bot and ref_msg:
                ...
                # Normal mention or DM chat history: grab recent messages within last 15 minutes (max 5 turns)
                # Prompt will automatically understand conversational context and fresh greetings
                try:
