...
* [🇻🇳 Phiên Bản Tiếng Việt](#-phiên-bản-tiếng-viet)
...
*(Xem sơ đồ Mermaid chi tiết ở phiên bản tiếng Anh để nắm rõ luồng dữ liệu liên thông)*
...
* **Matcha Shadowing (Luyện Phát Âm Từng Câu)**:
  * **Khởi tạo câu bằng AI**: Tự động tạo câu luyện nói ngẫu nhiên bằng Gemini phù hợp với cấp độ được chọn (`Easy` - Dễ, `Medium` - Vừa, `Hard` - Khó).
...
## 🏗️ Kiến Trúc Dự Án
*(Chi tiết cấu trúc thư mục vui lòng tham khảo bảng sơ đồ mục `Project Architecture` ở phần tiếng Anh)*
