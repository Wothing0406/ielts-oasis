...
export default function MeowchaGamePage() {
  ...
  return (
    <div className="min-h-screen bg-[#110b06] text-[#f9f5e8] flex flex-col font-sans">
      
      {/* ===================================================================== */}
      {/* 1. TOP HEADER & BRAND BAR */}
      {/* ===================================================================== */}
      <header className="w-full bg-[#1e130b] border-b-2 border-[#3b2719] px-3 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-3 shadow-md z-30 sticky top-0">
        
        {/* Brand & Back Button */}
        <div className="flex items-center gap-3">
          <Link
            href="/games"
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#281a11] hover:bg-[#3b2719] text-[#ffdf79] rounded-lg border border-[#543924] text-xs font-bold transition-all active:scale-95 cursor-pointer shadow-sm"
          >
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <button
            ...
            className="p-1.5 sm:px-2.5 sm:py-1.5 bg-[#281a11] hover:bg-[#3b2719] text-[#d8ccb0] rounded-lg border border-[#543924] text-xs font-semibold flex items-center gap-1 transition-all active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="p-1.5 sm:px-2.5 sm:py-1.5 bg-[#281a11] hover:bg-[#3b2719] text-[#eef5db] rounded-lg border border-[#543924] text-xs font-semibold flex items-center gap-1 transition-all active:scale-95 cursor-pointer"
      ...
      {/* ===================================================================== */}
      <div className="w-full bg-[#180f08] border-b border-[#3b2719] px-4 py-1.5 flex items-center justify-center">
        <div className="flex items-center gap-1.5 sm:gap-3 bg-[#24160d] p-1 rounded-xl border border-[#543924] max-w-2xl w-full justify-between sm:justify-center">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
              activeTab === "arena"
                ? "bg-[#789262] text-[#f9f5e8] shadow-md"
                : "text-[#d8ccb0] hover:text-[#ffdf79] hover:bg-[#3b2719]"
            }`}
          >
      ...
      {/* ===================================================================== */}
      {activeTab === "arena" && (
        <main className="flex-1 w-full flex flex-col items-center justify-center p-0 md:p-3" id="meowcha-frame-container">
          <div className="w-full max-w-5xl h-[86vh] md:h-[840px] bg-black rounded-none md:rounded-2xl overflow-hidden border-0 md:border-2 border-[#543924] shadow-2xl relative flex flex-col">
      ...
      {activeTab === "leaderboard" && (
        <main className="flex-1 w-full max-w-4xl mx-auto p-4 sm:p-6 flex flex-col gap-4">
          <div className="flex items-center justify-between border-b border-[#3b2719] pb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-lg bg-[#3b2719] border border-[#ffdf79] flex items-center justify-center">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[#281a11] hover:bg-[#3b2719] text-[#ffdf79] rounded-lg border border-[#543924] text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer"
            >
          ...
          <div className="w-full bg-[#1e130b] rounded-xl border border-[#3b2719] overflow-hidden shadow-xl">
            <div className="grid grid-cols-12 bg-[#281a11] px-4 py-2.5 border-b border-[#3b2719] text-[11px] sm:text-xs font-bold text-[#d8ccb0] uppercase tracking-wider">
            ...
            <div className="divide-y divide-[#2a1b10]">
              {leaderboard.map((item, idx) => (
                <div
                  key={item.id || idx}
                  className={`grid grid-cols-12 px-4 py-3 items-center text-xs transition-colors hover:bg-[#281a11]/80 ${
                    idx === 0
                      ? "bg-[#3b2719]/40 text-[#ffdf79]"
                      : idx === 1
                      ? "bg-[#281a11]/30 text-[#e2e8f0]"
                      : idx === 2
                      ? "bg-[#281a11]/20 text-[#fed7aa]"
                      : "text-[#d8ccb0]"
                  }`}
                >
                  {/* Hạng */}
                  ...
                  <div className="col-span-4 flex items-center gap-2">
                    ...
                    {idx === 0 && (
                      <span className="hidden sm:inline px-1.5 py-0.2 bg-[#ffdf79] text-[#1e130b] font-mono text-[9px] rounded font-bold">
                        TOP 1
                      </span>
                    )}
                  </div>
                  ...
                  <div className="col-span-3 flex items-center gap-1.5">
                    <span className="px-2 py-0.5 bg-[#281a11] rounded border border-[#543924] font-serif text-[11px] text-[#98b06f]">
      ...
      {activeTab === "saves" && (
        <main className="flex-1 w-full max-w-4xl mx-auto p-4 sm:p-6 flex flex-col gap-4">
          <div className="flex items-center justify-between border-b border-[#3b2719] pb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-lg bg-[#3b2719] border border-[#34d399] flex items-center justify-center">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[#281a11] hover:bg-[#3b2719] text-[#34d399] rounded-lg border border-[#543924] text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer"
            >
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-xl border-2 flex flex-col justify-between gap-4 transition-all shadow-lg ${
                    isOccupied
                      ? "bg-[#1e130b] border-[#789262] hover:border-[#ffdf79]"
                      : "bg-[#160d07] border-[#3b2719] opacity-80"
                  }`}
                >
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-[10px] font-mono px-2 py-0.5 rounded font-bold ${
                          isOccupied
                            ? "bg-[#789262] text-[#f9f5e8]"
                            : "bg-[#281a11] text-[#a09070]"
                        }`}
                      >
                    ...
                    <div className="p-2.5 bg-[#281a11] rounded-lg border border-[#3b2719] flex flex-col gap-1 text-xs">
                      <div className="flex justify-between">
                        <span className="text-[#a09070]">Cảnh Giới:</span>
                        <span className="font-bold text-[#f9f5e8]">
                          {isOccupied ? slot.realm : "--"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#a09070]">Khí Huyết:</span>
                        <span className="font-mono text-[#34d399]">
                          {isOccupied ? `${slot.hp} / ${slot.max_hp} HP` : "--"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#a09070]">Tu Vi Đạt:</span>
                        <span className="font-mono font-bold text-[#ffdf79]">
                          {isOccupied ? `${slot.score.toLocaleString()} pts` : "--"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#a09070]">Đã Trảm:</span>
                        <span className="font-mono text-[#98b06f]">
                          {isOccupied ? `${slot.words_slain} Từ` : "--"}
                        </span>
                      </div>
                      <div className="flex justify-between text-[11px] text-[#a09070] pt-1 border-t border-[#3b2719] mt-1">
                        <span>Cập nhật:</span>
                  ...
                  <button
                    ...
                    className={`w-full py-2 rounded-lg text-xs font-bold font-serif flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                      isOccupied
                        ? "bg-[#789262] hover:bg-[#8aa970] text-[#f9f5e8] shadow"
                        : "bg-[#281a11] text-[#6b584a] cursor-not-allowed"
                    }`}
                  >
      ...
      {activeTab === "vocab" && (
        <main className="flex-1 w-full max-w-5xl mx-auto p-4 sm:p-6 flex flex-col gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#3b2719] pb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-lg bg-[#3b2719] border border-[#60a5fa] flex items-center justify-center">
            ...
            <div className="relative w-full sm:w-64">
              <Search className="w-4 h-4 text-[#a09070] absolute left-3 top-2.5" />
              <input
                type="text"
                placeholder="Tra từ hoặc nghĩa..."
                value={vocabSearch}
                onChange={e => setVocabSearch(e.target.value)}
                className="w-full bg-[#1e130b] border border-[#543924] rounded-lg pl-9 pr-3 py-1.5 text-xs text-[#f9f5e8] placeholder-[#a09070] focus:outline-none focus:border-[#ffdf79]"
              />
            </div>
          </div>
            ...
            {[
              ...
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                  selectedBand === b.id
                    ? "bg-[#789262] text-[#f9f5e8] shadow"
                    : "bg-[#1e130b] text-[#d8ccb0] hover:bg-[#281a11] border border-[#3b2719]"
                }`}
              >
                {b.label}
              </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            {filteredVocab.map(item => {
              ...
              return (
                <div
                  key={item.id}
                  className="p-3.5 bg-[#1e130b] rounded-xl border border-[#3b2719] hover:border-[#ffdf79] transition-all flex flex-col justify-between gap-2 shadow"
                >
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      ...
                      <span className="text-[10px] px-1.5 py-0.2 bg-[#281a11] text-[#a09070] rounded border border-[#543924]">
                        {item.type}
                      </span>
                    </div>
      ...
      {/* 7. FOOTER */}
      {/* ===================================================================== */}
      <footer className="w-full bg-[#1e130b] border-t border-[#3b2719] py-2 px-4 text-center text-xs text-[#a09070] font-serif">
